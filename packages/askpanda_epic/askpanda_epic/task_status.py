"""ePIC PanDA task status tool — askpanda_epic plugin package.

Delegates to the canonical implementation in
``askpanda_epic.task_status_impl``. Falls back to
...
try:
    from askpanda_epic.task_status_impl import (  # noqa: F401
        PandaTaskStatusTool,
        get_definition,
        panda_task_status_tool,
    )
except ImportError:
    from askpanda_epic._fallback_tool import (  # type: ignore[no-redef]  # noqa: F401,F811
